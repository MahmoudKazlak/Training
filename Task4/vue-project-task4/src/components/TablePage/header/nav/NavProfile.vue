  ...
  <div class="dropdown  position-relative">
    ...
    <ul class="dropdown-menu dropdown-menu-end">
      ...
      <li class="text-center border-bottom">
        <button class="btn border d-flex p-2 mx-auto mb-8 fw-medium gray">{{ $t('Edit profile') }}</button>
      </li>

      <li class="border-bottom textRev">
        <a
      ...
      <li>
        <a
          class="dropdown-item mt-3 fw-medium textRev"
          href="#"
        >{{ $t('Logout') }}</a>
      </li>
    </ul>
